...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-2">Gerencie todas as categorias de produtos e serviços</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($categoria->icone)
                                <img src="{{ asset('storage/' . $categoria->icone) }}" alt="Ícone" class="w-10 h-10 object-contain rounded bg-gray-100">
                            @else
                    ...
                    <tr>
                        <td colspan="3" class="px-6 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-sm">Cadastre a primeira categoria clicando no botão "Nova Categoria"</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
