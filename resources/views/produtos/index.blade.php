            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 font-mono">{{ $produto->preco ? 'R$ ' . number_format($produto->preco, 2, ',', '.') : '-' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                ...
                                <form action="{{ route('admin.produtos.duplicate', $produto) }}" method="POST" class="inline">
                                    @csrf
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-sm">Cadastre o primeiro produto clicando no botão "Novo Produto"</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
